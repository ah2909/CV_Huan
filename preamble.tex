...
\usepackage[
    pdftitle={Cao Anh Huan's CV},
    pdfauthor={Cao Anh Huan},
...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Cao Anh Huan - Page \thepage{} of \pageref*{LastPage}}
...
\newenvironment{highlights}{
    \interlinepenalty=10000  % keep each bullet together; never split an item across pages
    \begin{itemize}[
        topsep=0.10 cm,
        parsep=0.10 cm,
        partopsep=0pt,
